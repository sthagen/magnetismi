...
def test_coefficients_from_within_models_available():
    ...
    assert coefficients.epoch == 2020
    assert coefficients.model == 'WMM-2020'
    assert coefficients.modeldate == '12/10/2019'
    assert len(coefficients.data) == 90
